...
<div class="wrap">
    <div class="bread_box">
        ...
        <span> &gt;</span>
        <%--route--%>
        <a href="${ctx}/RouteServlet?action=findAllByCid&pageNumber=1&pageSize=5&cid=${cid}">${route.category.cname}</a><span> &gt;</span>
    ...
    <div class="prosum_box">
        <dl class="prosum_left">
            ...
            <dd>
                ...
                <%-- 有两个箭头，代表向上向下
                    所以 循环超过了四次 后续的加上 style="display:none;"   count循环的数量  --%>
                <c:forEach var="img" varStatus="status" items="${route.routeImgList}">
